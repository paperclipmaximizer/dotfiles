;;; Compiled snippets and support files for `godot-gdscript-mode'
...
;;; Snippet definitions:
;;;
(yas-define-snippets 'godot-gdscript-mode
		     '(("while" "while (${1:condition}):\n$0\n" "While" nil
			("Control Flow")
			nil "/home/liam/.emacs.d/snippets/godot-gdscript-mode/while" nil nil)
			...
			("View Port")
			nil "/home/liam/.emacs.d/snippets/godot-gdscript-mode/viewport_size" nil nil)
			...
			("View Port")
			nil "/home/liam/.emacs.d/snippets/godot-gdscript-mode/viewport_screenshot" nil nil)
		       ("v3" "Vector3(${1:x}, ${2:y}, ${3:z})$0\n" "Vector3" nil
			("Data Types")
			nil "/home/liam/.emacs.d/snippets/godot-gdscript-mode/vector3" nil nil)
		       ("v2" "Vector2(${1:x}, ${2:y})$0\n" "Vector2" nil
			("Data Types")
			nil "/home/liam/.emacs.d/snippets/godot-gdscript-mode/vector2" nil nil)
			...
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/varsetget" nil nil)
		       ("vs" "var ${1:variable_name} = ${2:variable_value} setget set_$1\n\nfunc set_$1(new_value):\n    $1 = new_value\n$0\n" "Variable with Set Method" nil
			("Classes")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/varset" nil nil)
		       ("onready" "onready var ${1:variable_name} = ${2:variable_value}\n" "Variable with On Ready" nil
			("Classes")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/varonready" nil nil)
		       ("vg" "var ${1:variable_name} = ${2:variable_value} setget .get_$1\n\nfunc get_$1():\n    return $1\n$0\n" "Variable with Get Method" nil
			("Classes")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/varget" nil nil)
		       ("varexport" "export (${1:String${2:, \"Option1\", \"Option2\"}}) var ${3:variable_name} = ${4:variable_value}\n" "Variable (Exported to the Editor)" nil
			("Classes")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/varexport" nil nil)
		       ("_unpaused" "func _unpaused():\n     $0\n" "Virtual Function: _unpaused()" nil
			("Nodes")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/unpaused" nil nil)
		       ("tr" "tr(\"${1:string_code}\")\n" "Translatable String" nil
			("Internationalization")
			nil "/home/liam/.emacs.d/snippets/godot-gdscript-mode/tr" nil nil)
		       ("s" "func $1($2):$3\n     $4" "stub" nil nil nil "/home/liam/.emacs.d/snippets/godot-gdscript-mode/stub" nil nil)
		       ("scene_preload" "var ${1:scene} = preload(\"res://${2:scene_path}\")\nvar ${3:node} = $1.instance()\n# Add the node as child of the current scene.\nadd_child($3)\n$0\n" "Pre-load Scene" nil
			("Scenes")
			nil "/home/liam/.emacs.d/snippets/godot-gdscript-mode/scene_preload" nil nil)
		       ("scene_load" "var ${1:scene} = load(\"res://${2:scene_path}\")\nvar ${3:node} = $1.instance()\n# Add the node as child of the current scene.\nadd_child($3)\n$0\n" "Load Scene" nil
			("Scenes")
			nil "/home/liam/.emacs.d/snippets/godot-gdscript-mode/scene_load" nil nil)
		       ("scene_change" "get_tree().change_scene(\"res://${1:scene_path}\")\n$0\n" "Change Scene" nil
			("Scenes")
			nil "/home/liam/.emacs.d/snippets/godot-gdscript-mode/scene_change" nil nil)
		       ("resource_preload" "var ${1:resource} = preload(\"res://${2:resource_path}\")\n$0\n" "Pre-load Resource" nil
			("Resources")
			nil "/home/liam/.emacs.d/snippets/godot-gdscript-mode/resource_preload" nil nil)
		       ("resource_load" "var ${1:resource} = load(\"res://${2:resource_path}\")\n$0\n" "Load Resource" nil
			("Resources")
			nil "/home/liam/.emacs.d/snippets/godot-gdscript-mode/resource_load" nil nil)
		       ("r2" "Rect2(${1:x}, ${2:y}, ${3:width}, ${4:height})$0\n" "Rect2" nil
			("Data Types")
			nil "/home/liam/.emacs.d/snippets/godot-gdscript-mode/rect2" nil nil)
			...
			("Nodes")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/ready" nil nil)
		       ("_process" "func _process(${1:delta}):\n     $0\n" "Virtual Function: _process()" nil
			("Nodes")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/process" nil nil)
			...
			("Editor Plugin")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/plugin_script_type" nil nil)
			...
			("Nodes")
			nil "/home/liam/.emacs.d/snippets/godot-gdscript-mode/node_duplicate" nil nil)
		       ("input_mouse_position" "var ${1:mouse_position} = get_viewport().get_mouse_pos()\n$0\n" "Get the Mouse Position" nil
			("Input")
			nil "/home/liam/.emacs.d/snippets/godot-gdscript-mode/input_mouse_position" nil nil)
			...
			("Input")
			nil "/home/liam/.emacs.d/snippets/godot-gdscript-mode/input_event" nil nil)
		       ("input_action" "var ${1:input_event} = InputEvent()\n$1.type = InputEvent.ACTION\n$1.set_as_action(\"$2\", ${3:true})\nget_tree().input_event($1)\n" "Send Input Action" nil
			("Input")
			nil "/home/liam/.emacs.d/snippets/godot-gdscript-mode/input_action" nil nil)
		       ("_input" "func _input(${1:event}):\n     if ($1 == InputEvent.${2:MOUSE_BUTTON}):\n         if ($1.${3:button_index} == ${4:BUTTON_LEFT}):\n             $0\n" "Virtual Function: _input()" nil
			("Nodes")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/input" nil nil)
		       ("ife" "if (${1:condition}):\n    ${2:pass}\nelse:\n    $0\n" "If/Else" nil
			("Control Flow")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/ifelse" nil nil)
		       ("if" "if (${1:condition}):\n$0\n" "If" nil
			("Control Flow")
			nil "/home/liam/.emacs.d/snippets/godot-gdscript-mode/if" nil nil)
		       ("_input_event" "func _input_event(${1:event}):\n     if ($1 == InputEvent.${2:MOUSE_BUTTON}):\n         if ($1.${3:button_index} == ${4:BUTTON_LEFT and $1.pressed}):\n             $0\n" "Virtual Function: _input_event()" nil
			("GUI Controls")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/gui_input_event" nil nil)
		       ("sfunc" "static func ${1:function_name}(${2:parameters}):\n    ${3:pass}\n" "Function (Static)" nil
			("Functions")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/function_static" nil nil)
		       ("func" "func ${1:function_name}(${2:parameters}):\n    ${3:pass}\n" "Function" nil
			("Functions")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/function" nil nil)
		       ("forr" "for ${1:variable} in range(${2:end / start, end / start, end, increment}):\n$0\n" "For In Range" nil
			("Control Flow")
			nil "/home/liam/.emacs.d/snippets/godot-gdscript-mode/forr" nil nil)
		       ("fori" "for ${1:variable} in ${2:collection}:\n$0\n" "For In" nil
			("Control Flow")
			nil "/home/liam/.emacs.d/snippets/godot-gdscript-mode/fori" nil nil)
		       ("_fixed_process" "func _fixed_process(${1:delta}):\n     $0\n" "Virtual Function: _fixed_process()" nil
			("Nodes")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/fixed_process" nil nil)
			...
			("Files")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/file_write" nil nil)
			...
			("Files")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/file_read" nil nil)
			...
			("Files")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/file_ini_write" nil nil)
			...
			("Files")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/file_ini_read" nil nil)
		       ("_exit_tree" "func _exit_tree():\n     $0\n" "Virtual Function: _exit_tree()" nil
			("Nodes")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/exit_tree" nil nil)
		       ("enum" "const ${1:ENUM} = {\n    ${2:KEY} = ${3:VALUE},\n}\n$0\n" "Enumeration" nil
			("Classes")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/enum" nil nil)
		       ("_enter_tree" "func _enter_tree():\n     $0\n" "Virtual Function: _enter_tree()" nil
			("Nodes")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/enter_tree" nil nil)
		       ("elif" "elif (${1:condition}):\n$0\n" "Elif" nil
			("Control Flow")
			nil "/home/liam/.emacs.d/snippets/godot-gdscript-mode/elif" nil nil)
		       ("_draw" "func _draw():\n    ${1:pass}\n" "Virtual Function: _draw()" nil
			("Canvas Items")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/draw" nil nil)
		       ("const" "const ${1:constant_name} = ${2:constant_value}\n" "Constant" nil
			("Classes")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/const" nil nil)
		       ("connect" "get_node(\"${1:node}\").connect(\"${2:event}\", ${3:self}, \"${4:function}\")\n" "Connect to Event/Callback" nil
			("Objects")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/connect" nil nil)
			...
			("Classes")
			((yas-indent-line 'fixed))
			"/home/liam/.emacs.d/snippets/godot-gdscript-mode/class" nil nil)))
