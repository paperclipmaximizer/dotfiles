...
(yas-define-snippets 'dix-mode
			...
			nil nil "/home/liam/.emacs.d/snippets/dix-mode/with-param" "direct-keybinding" nil)
		       ("w" "<when>$0</when>" "<when> elements"
			(progn
			  (backward-char 1)
			  (dix-transfer-enclosing-allows "when"))
			nil nil "/home/liam/.emacs.d/snippets/dix-mode/when" "direct-keybinding" nil)
		       ("v" "<var n=\"$1\"/>$0" "<var> elements"
			(progn
			  (backward-char 1)
			  (dix-transfer-enclosing-allows "var"))
			nil nil "/home/liam/.emacs.d/snippets/dix-mode/var" "direct-keybinding" nil)
			  ...
			  (and
			   ...
			   (not
			    (member
			     ...
			     '("l" "r" "i" "g" "sdefs")))))
			nil nil "/home/liam/.emacs.d/snippets/dix-mode/section" "direct-keybinding" nil)
		       ("<s" "<sdef n=\"$1\"  c=\"$2\"/>\n" "<sdef> element"
			(progn
			  (backward-char 2)
			  (equal
			   (dix-enclosing-elt 'noerror)
			   "sdefs"))
			nil nil "/home/liam/.emacs.d/snippets/dix-mode/sdef" "direct-keybinding" nil)
		       ("<s" "<s n=\"$1\"/>$0" "<s> element"
			(progn
			  (backward-char 2)
			  (member
			   (dix-enclosing-elt 'noerror)
			   '("l" "r" "i" "g")))
			nil nil "/home/liam/.emacs.d/snippets/dix-mode/s" "direct-keybinding" nil)
			...
			(progn
			  ...
			  (not
			   (equal
			    (dix-enclosing-elt 'noerror)
			    "e")))
			nil nil "/home/liam/.emacs.d/snippets/dix-mode/pardef" "direct-keybinding" nil)
			...
			(progn
			  ...
			  (equal
			   (dix-enclosing-elt 'noerror)
			   "e"))
			nil nil "/home/liam/.emacs.d/snippets/dix-mode/par" "direct-keybinding" nil)
			...
			(progn
			  ...
			  (equal
			   (dix-enclosing-elt 'noerror)
			   "e"))
			nil nil "/home/liam/.emacs.d/snippets/dix-mode/p" "direct-keybinding" nil)
		       ("o" "<otherwise>$0</otherwise>" "<otherwise> elements"
			(progn
			  (backward-char 1)
			  (dix-transfer-enclosing-allows "otherwise"))
			nil nil "/home/liam/.emacs.d/snippets/dix-mode/otherwise" "direct-keybinding" nil)
		       ("lt" "<lit-tag v=\"$1\"/>$0" "<lit-tag> elements"
			(progn
			  (backward-char 1)
			  (dix-transfer-enclosing-allows "lit-tag"))
			nil nil "/home/liam/.emacs.d/snippets/dix-mode/lit-tag" "direct-keybinding" nil)
		       ("l" "<lit v=\"$1\"/>$0" "<lit> elements"
			(progn
			  (backward-char 1)
			  (dix-transfer-enclosing-allows "lit"))
			nil nil "/home/liam/.emacs.d/snippets/dix-mode/lit" "direct-keybinding" nil)
		       ("l" "<let>$0</let>" "<let> elements"
			(progn
			  (backward-char 1)
			  (dix-transfer-enclosing-allows "let"))
			nil nil "/home/liam/.emacs.d/snippets/dix-mode/let" "direct-keybinding" nil)
		       ("<e" "<e> <p><l>$1</l>  <r>$1$0</r></p> </e>\n" "<e> in pardefs"
			(not
			 (dix-enclosing-is-mono-section))
			nil nil "/home/liam/.emacs.d/snippets/dix-mode/e-in-pardef" "direct-keybinding" nil)
		       ("<e" "<e lm=\"${1:`(dix-yas-prev-lemma)`}\"> <i>${1:$(dix-yas-lm-to-i)}</i> <par n=\"${3:$$(dix-yas-choose-pdname)}\"/></e>\n$0" "<e> in monodix section"
			(dix-enclosing-is-mono-section)
			nil nil "/home/liam/.emacs.d/snippets/dix-mode/e-in-mono-section" "direct-keybinding" nil)
		       ("c" "<clip pos=\"$1\" ${2:side=\"tl\"} part=\"$3\"/>$0" "<clip> elements"
			(progn
			  (backward-char 1)
			  (dix-transfer-enclosing-allows "clip"))
			nil nil "/home/liam/.emacs.d/snippets/dix-mode/clip" "direct-keybinding" nil)
		       ("c" "<choose><when>\n  <test><equal>$0</equal></test>\n\n</when></choose>\n" "<choose><when><test> elements"
			(progn
			  (backward-char 1)
			  (dix-transfer-enclosing-allows "choose"))
			nil nil "/home/liam/.emacs.d/snippets/dix-mode/choose" "direct-keybinding" nil)
